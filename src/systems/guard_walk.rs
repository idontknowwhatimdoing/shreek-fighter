					...
					match player.orientation {
						Orientation::Left => {
							if input.axis_value("guard").unwrap() < 0.0 {
								if sprite.sprite_number < 8 || sprite.sprite_number > 15 {
									sprite.sprite_number = 8;
								}
								self.frame_count += 1;
								if self.frame_count == 6 {
									if sprite.sprite_number < 15 {
										sprite.sprite_number += 1;
									} else if sprite.sprite_number == 15 {
										sprite.sprite_number = 8;
									}
									self.frame_count = 0;
								}
						...
						Orientation::Right => {
							if input.axis_value("guard").unwrap() > 0.0 {
								...
								if self.frame_count == 6 {
									if sprite.sprite_number < 7 {
										sprite.sprite_number += 1;
									} else if sprite.sprite_number == 7 {
										sprite.sprite_number = 0;
									}
									self.frame_count = 0;
								}
